...
async def send_post_request(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=detail if detail else "中科融合算力中心大模型服务平台: Server Connection Error",
        )
...
async def verify_connection(
    ...
    async with aiohttp.ClientSession(
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail="中科融合算力中心大模型服务平台: Server Connection Error"
            )
        except Exception as e:
...
async def get_openai_models(
    ...
    if url_idx is None:
        ...
        try:
            ...
            log.exception(e)
            error_detail = "中科融合算力中心大模型服务平台: Server Connection Error"
            if r is not None:
                try:
                    res = r.json()
                    if "error" in res:
